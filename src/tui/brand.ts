/** Shared welcome identity for every terminal UI entrypoint. */
export const TUI_BRAND_NAME = "mini-agent";
export const TUI_BRAND_MARK = "✣";
export const TUI_BRAND_SPARK = "✦";
/**
 * Version shown in the welcome panel. It must track `package.json`;
 * `test/tui-brand.test.ts` fails when the two drift apart.
 */
export const TUI_BRAND_VERSION = "0.1.7";
